...
Для начала необходимо создать индекс на основании Ваших данных. Этот процесс при большом кол-ве записей может изрядно потратить ресурсов, но оно того стоит.
